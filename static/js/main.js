const app = Vue.createApp({
    ...
    methods: {
        onSubmitBc(e) {
            ...
            topr = this.topr
            const url = 'https://github-api-chart.vercel.app/rest/api/repos'
        ...
        onSubmitLc(e) {
            ...
            const url = "https://github-api-chart.vercel.app/rest/api/repos/" + org + "/" + repo + "/commits/"
...
function getLineChart(dataset) {
    ...
    var labels = []
    var datasets = []
    for (let index = dataset.length; index > 0; index--) {
        labels.push(dataset[index-1].date);
        datasets.push(dataset[index-1].commits)
    }
